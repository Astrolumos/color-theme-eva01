;;; color-theme-eva01.el --- Evangelion Unit-01 color theme for GNU Emacs 24

;; Copyright (C) 2016 Ziang Yan <yanza.cosmo@gmail.com>
...
(defun color-theme-eva01 ()
  "Color theme by Ziang, created 2015-03-27."
  (interactive)
  (color-theme-install
   '(color-theme-eva
     ...
     (fl-doc-string-face ((t (:foreground "lightcoral"))))
     ...
     (font-lock-builtin-face ((t (:foreground "#B6DF5B"))))
     (font-lock-comment-face ((t (:foreground "#B862F4"))))
     (font-lock-constant-face ((t (:foreground "#B6DF5B"))))
     (font-lock-doc-string-face ((t (:foreground "orange"))))
     (font-lock-function-name-face ((t (:foreground "#7D9EE1"))))
     (font-lock-keyword-face ((t (:bold t :foreground "#2EF14B"))))
     (font-lock-preprocessor-face ((t (:foreground "Aquamarine"))))
     (font-lock-reference-face ((t (:foreground "#2EF14B"))))
     (font-lock-string-face ((t (:foreground "Orange"))))
     (font-lock-type-face ((t (:foreground "Orange"))))
     (font-lock-variable-name-face ((t (:foreground "#C2FF96"))))
     ...
     (italic ((t (nil))))
     (left-margin ((t (nil))))
     (warning ((,class (:foreground ,blue))))
     (list-mode-item-selected ((t (:background "grey68" :foreground "white"))))
     ...
     (modeline ((t (:background "grey" :foreground "black" :box (:line-width 1 :style released-button)))))
     (modeline ((t (:foreground "black" :background "#7a7a7a" )))) 
...
;;; color-theme-eva01.el ends here
